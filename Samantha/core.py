...
def generate_index():
    ...
    for key in key_index.keys():
        ...
        key_index_list.append("{key} {plugins}".format(key=key_name, plugins=", ".join(sorted(key_plugins))))
...
class Daemon:
    ...
    I don't think that I'm using this anymore, credit goes to http://www.jejik.com/articles/2007/02/a_simple_unix_linux_daemon_in_python/ though.
    """
